...
export const site = {
  ...
  // On Vercel this resolves to the current production domain (vercel.app now,
  // www.mosleyprime.com automatically once the custom domain is attached).
  url: process.env.VERCEL_PROJECT_PRODUCTION_URL
    ? `https://${process.env.VERCEL_PROJECT_PRODUCTION_URL}`
    : "https://www.mosleyprime.com",
